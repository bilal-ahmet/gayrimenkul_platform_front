    ...
    <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center flex-wrap">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-9 pr-4 py-2 rounded-xl border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent w-56"
        />
      </div>
